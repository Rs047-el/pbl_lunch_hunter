...
(user_id, user_l_name, user_f_name, user_l_kana, user_f_kana, user_account, password, usertype_id)
VALUES
('u0001','佐藤','太郎','サトウ','タロウ','佐藤太郎','1234','1'),
('u0002','鈴木','花子','スズキ','ハナコ','鈴木花子','1234','1'),
('u0003','高橋','一郎','タカハシ','イチロウ','高橋一郎','1234','1'),
('u0004','田中','美咲','タナカ','ミサキ','田中美咲','1234','1'),
('u0005','渡辺','健','ワタナベ','ケン','渡辺健','1234','1'),
('u0006','伊藤','優','イトウ','ユウ','伊藤優','1234','1'),
('u0007','山本','彩','ヤマモト','アヤ','山本彩','1234','1'),
('u0008','中村','翔','ナカムラ','ショウ','中村翔','1234','1'),
('u0009','小林','奈々','コバヤシ','ナナ','小林奈々','1234','1'),
('u0010','加藤','直樹','カトウ','ナオキ','加藤直樹','1234','1')
;
